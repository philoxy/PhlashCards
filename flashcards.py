...
class Ui_flashcards(object):
    def setupUi(self, flashcards):
        ...
        self.label_stats.setGeometry(QRect(10, 450, 301, 21))
        self.label_acc = QLabel(flashcards)
        self.label_acc.setObjectName(u"label_acc")
        self.label_acc.setGeometry(QRect(330, 450, 301, 21))
        self.label_acc.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
