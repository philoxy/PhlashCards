...
"}\n"
"\n"
"QPushButton, QComboBox, QComboBox::drop-down, QCombBox:on {\n"
...
"}\n"
"\n"
"QPushButton:pressed, QComboBox:pressed, QListView {\n"
...
"}\n"
"\n"
"QListView:hover:!pressed {\n"
"	background-color: qlineargradient(spread:pad, x1:1, y1:0.503, x2:1, y2:0, stop:0 rgba(75, 132, 255, 255), stop:1 rgba(94, 207, 255, 255));\n"
"}\n"
"\n"
"\n"
"QPushButton:disabled, QComboBox:disabled, QCheckBox::indicator:disabled {\n"
"	background-color: rgb(13, 54, 142);\n"
"}\n"
"\n"
"QPushButton:hover:!pressed, QComboBox:hover:!pressed {\n"
